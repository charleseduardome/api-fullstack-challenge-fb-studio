...
describe('CreateQuestion', () => {
  beforeEach(() => {
    ...
    listQuestions = new ListQuestionsService(fakeQuestionsRepository);
  });

  it('shoul be able to list all questions', async () => {
    ...
    expect(questions).toEqual([question01, question02, question03]);
  });
});
